...
// KMS-style symmetric encryption: a single master key from env, AES-256-GCM with
// per-value random IV and auth tag. Swap `key` for a KMS data key later if needed.
